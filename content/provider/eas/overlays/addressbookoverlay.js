tbSync.eas.onInjectIntoAddressbook = function (window) {
	if (!tbSync.eas.hasOwnProperty("DisplayCardViewPane_ORIG")) {
...
tbSync.eas.onRemoveFromAddressbook = function (window) {
	if (tbSync.eas.hasOwnProperty("DisplayCardViewPane_ORIG")) {
		window.DisplayCardViewPane = tbSync.eas.DisplayCardViewPane_ORIG;
		delete tbSync.eas.DisplayCardViewPane_ORIG;
	}
}