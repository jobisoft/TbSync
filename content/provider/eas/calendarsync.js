...
eas.sync.Calendar = {
    ...
    getWbxmlFromThunderbirdItem: function (item, syncdata) {
        ...
        */
        ...
        //TRANSP / BusyStatus
        wbxml.atag("BusyStatus", tbSync.eas.sync.Calendar.getItemPropertyWithFallback(item, "TRANSP", "X-EAS-BusyStatus", this.MAP_TB_TRANSP, this.MAP_EAS_BUSYSTATUS));
        
        //CLASS / Sensitivity
        wbxml.atag("Sensitivity", tbSync.eas.sync.Calendar.getItemPropertyWithFallback(item, "CLASS", "X-EAS-Sensitivity", this.MAP_TB_CLASS, this.MAP_EAS_SENSITIVITY));
