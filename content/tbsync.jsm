...
var tbSync = {
    ...
    init: Task.async (function* (window)  { 
        ...
        yield tbSync.overlayManager.registerOverlay("chrome://messenger/content/addressbook/abNewCardDialog.xul", "chrome://tbsync/content/overlays/abNewCardIconsOverlay.xul");
